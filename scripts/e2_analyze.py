...
def write_report(df, summary_path, report_path):
    ...
    report_lines = [
        ...
        "- **Proof Components**: E1 Plonky3 base proofs (C1 Geofence, C2 Poseidon2 Merkle, C3 Threshold/Time, C4 Actor Auth, C5 Nullifier).",
        ...
        "- **Disclaimer**: Reported numbers represent **prototype base proof pipeline latency**. Rust recursive C1-C5 proof/verification exists but is not included in this timing and no direct EVM verifier is present.",
        "",
        "## Summary Metrics",
        "",
