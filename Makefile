...
e2-quick:
	cargo run --release -p e2-bench -- --profile quick --lambda-events-per-min 480 --duration-min 5 --seeds 3 --l1-mode mock --out results/e2/raw.csv --summary-out results/e2/summary.csv --metadata-out results/e2/metadata.json
	python3 scripts/e2_analyze.py --raw results/e2/raw.csv --out-dir results/e2 --cdf-out results/e2/cdf.png --report-out results/e2/report.md

e2:
	cargo run --release -p e2-bench -- --profile full --lambda-events-per-min 480 --duration-min 60 --seeds 30 --l1-mode mock --out results/e2/raw.csv --summary-out results/e2/summary.csv --metadata-out results/e2/metadata.json
	python3 scripts/e2_analyze.py --raw results/e2/raw.csv --out-dir results/e2 --cdf-out results/e2/cdf.png --report-out results/e2/report.md

e2-strict:
	cargo run --release -p e2-bench -- --profile full --lambda-events-per-min 480 --duration-min 60 --seeds 30 --l1-mode anvil --out results/e2/raw.csv --summary-out results/e2/summary.csv --metadata-out results/e2/metadata.json
	python3 scripts/e2_analyze.py --raw results/e2/raw.csv --out-dir results/e2 --cdf-out results/e2/cdf.png --report-out results/e2/report.md
